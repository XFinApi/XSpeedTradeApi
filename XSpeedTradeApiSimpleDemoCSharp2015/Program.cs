/*******************************************************
* XSpeedTradeApiSimpleDemoCSharp2015
* www.xfinapi.com
*******************************************************/
using System;
...
namespace XSpeedTradeApiSimpleDemoCSharp2015
{
    class Program
    {
        //////////////////////////////////////////////////////////////////////////////////
        ...
        class Config
        {
            ...
            public string UserName = "000300000649";//公用测试账户。为了测试准确，请注册使用您自己的账户。
        ...
        {
            Console.WriteLine(string.Format("  Balance={0:g}, Available={1:g}, CurrMargin={2:g}, Commission={3:g}, PositionProfit={4:g}, CloseProfit={5:g}, FrozenCash={6:g}, Withdraw={7:g}, Deposit={8:g}\n",
                acc.Balance, acc.Available, acc.CurrMargin, acc.Commission,
                acc.PositionProfit, acc.CloseProfit, acc.FrozenCash, 
        ...
        static void MarketTest()
        {
            ...
            market = ITradeApi.XFinApi_CreateMarketApi("XTA_W32/Api/XSpeed_v1.5.1.9_20170830/XFinApi.XSpeedTradeApi.dll", out err);
        ...
        static void TradeTest()
        {
            ...
            trade = ITradeApi.XFinApi_CreateTradeApi("XTA_W32/Api/XSpeed_v1.5.1.9_20170830/XFinApi.XSpeedTradeApi.dll", out err);
