######################################################
# XSpeedTradeApiSimpleDemoPythonPyCharmC2018
# www.xfinapi.com
######################################################
...
class MarketEvent(XFinApi_TradeApi.MarketListener):
    ...
    def OnTick(self,tick):
        if self.cfg.AskPrice1 <= 0 and self.cfg.BidPrice1 <= 0:
            print(" Tick,{} {}, HighestPrice={}, LowestPrice={}, BidPrice0={}, BidVolume0={}, AskPrice0={}, AskVolume0={}, LastPrice={}, TotalVolume={}, TradingDay={}, TradingTime={}".format(
                tick.ExchangeID,
                tick.InstrumentID,
                tick.HighestPrice,
                tick.LowestPrice,
...
class MarketTest:
    ...
    def test(self):
        self.market = XFinApi_TradeApi.XFinApi_CreateMarketApi("XTA_W32/Api/XSpeed_v1.5.1.9_20170830/XFinApi.XSpeedTradeApi.dll")
...
class TradeEvent(XFinApi_TradeApi.TradeListener):
    ...
    def OnQueryAccount(self,accInfo):
         ...
         print(" Balance={}, Available={}, CurrMargin={}, Commission={}, PositionProfit={}, "
               "CloseProfit={}, FrozenCash={}, Withdraw={}, Deposit={}".format(
             accInfo.Balance, accInfo.Available, accInfo.CurrMargin, accInfo.Commission, accInfo.PositionProfit,
             accInfo.CloseProfit, accInfo.FrozenCash, accInfo.Withdraw, accInfo.Deposit))
...
class TradeTest:
    ...
    def Test(self):
        ...
        self.trade = XFinApi_TradeApi.XFinApi_CreateTradeApi(
            "XTA_W32/Api/XSpeed_v1.5.1.9_20170830/XFinApi.XSpeedTradeApi.dll")
