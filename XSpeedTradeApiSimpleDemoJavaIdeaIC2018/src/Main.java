/*******************************************************
 * XSpeedTradeApiSimpleDemoJavaIdeaIC2018
 * www.xfinapi.com
 *******************************************************/
...
public class Main {
    ...
    public static class Config {
        ...
        //地址账户
        public String MarketAddress = "203.187.171.250:10915";
        public String TradeAddress = "203.187.171.250:10910";
        public String UserName = "000300000649";
    ...
    static void PrintTickInfo(XFinApi.TradeApi.Tick tick) {
        System.out.println(String.format(" Tick,%s %s, HighestPrice=%g, LowestPrice=%g, BidPrice0=%g, BidVolume0=%d, AskPrice0=%g, AskVolume0=%d, LastPrice=%g, TotalVolume=%d, TradingDay=%s, TradingTime=%s",
                tick.getExchangeID(),
    ...
    static void PrintAccountInfo(XFinApi.TradeApi.Account acc) {
        System.out.println(String.format("  Balance=%g, Available=%g, CurrMargin=%g, Commission=%g, PositionProfit=%g, CloseProfit=%g, FrozenCash=%g, Withdraw=%g, Deposit=%g\n",
		acc.getBalance(), acc.getAvailable(), acc.getCurrMargin(), acc.getCommission(),
		acc.getPositionProfit(), acc.getCloseProfit(), acc.getFrozenCash(),
    ...
    static void MarketTest() {
        ...
        market = XFinApi.TradeApi.ITradeApi.XFinApi_CreateMarketApi("XTA_W32/Api/XSpeed_v1.5.1.9_20170830/XFinApi.XSpeedTradeApi.dll", err);
    ...
    static void TradeTest() {
        ...
        trade = XFinApi.TradeApi.ITradeApi.XFinApi_CreateTradeApi("XTA_W32/Api/XSpeed_v1.5.1.9_20170830/XFinApi.XSpeedTradeApi.dll", err);
